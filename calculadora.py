...
font_caderno = Font(family="Comic Sans MS", size=20)
# label
label = ttk.Label(frame, text='Formato:', font=font_caderno)
...
label_2 = ttk.Label(frame, text='Cor da borda:', font=font_caderno)
...
label_3 = ttk.Label(frame, text = 'Cor Preenchimento', font=font_caderno)
